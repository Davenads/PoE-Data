/**
 * Discord emoji mappings for PoE2 currencies
 * Emojis are hosted across multiple Discord servers due to the 100 emoji limit
 */
...
export const EMOJIS: Readonly<EmojiMap> = {
