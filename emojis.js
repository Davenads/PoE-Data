// Auto-generated from item_emojis.py (dict: list)
// You can edit safely; this file is a flat key -> emoji string map.
// Values can be "<:name:id>", "<a:name:id>", or plain Unicode.
export const EMOJIS = {
...
// Ultra-thin helper; returns "" if unknown.
